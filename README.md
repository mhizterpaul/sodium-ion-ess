...
*   **Material Discovery**: Robust property derivation for eco-friendly, **non-fluorinated salts** (NaTCP, NaBOB), Fe-site doping (**Cr**, **Mn**, **Ni**), and electrode functionalization (**MTMS**) using OQMD APIs. Physical performance deltas (voltage, diffusivity, conductivity) are derived from fundamental thermodynamic and electronic states.
